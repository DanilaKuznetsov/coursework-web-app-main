...
на тему «Разработка веб-приложения для управления ассортиментом и заказами
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.1. Обзор существующих интернет-магазинов электроники и систем управления заказами        & 10                 & 22.03.2026    &                     \\ \hline
    Задача 1.2. Анализ программных средств разработки веб-приложений (Flask, Django, FastAPI)         & 7                  & 26.03.2026    &                     \\ \hline
    Задача 1.3. Формулировка цели, задач и требований к проекту                                       & 8                  & 30.03.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 2. Проектирование веб-приложения}}                                                                          \\ \hline
    Задача 2.1. Анализ целевой аудитории (покупатели, менеджеры, администраторы)                      & 5                  & 02.04.2026    &                     \\ \hline
    Задача 2.2. Описание функциональности приложения                                                  & 7                  & 06.04.2026    &                     \\ \hline
    Задача 2.3. Проектирование модели данных (товары, категории, пользователи, заказы, корзина)       & 8                  & 10.04.2026    & ER-диаграмма        \\ \hline
    Задача 2.4. Разработка макетов страниц и пользовательских сценариев                               & 5                  & 14.04.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 3. Разработка веб-приложения}}                                                                              \\ \hline
    Задача 3.1. Разработка базовой структуры приложения и вёрстка пользовательского интерфейса        & 8                  & 21.04.2026    &                     \\ \hline
    Задача 3.2. Реализация аутентификации пользователей и разграничения прав доступа                  & 7                  & 27.04.2026    & RBAC                \\ \hline
    Задача 3.3. Реализация CRUD-интерфейса для товаров, категорий и заказов                           & 7                  & 03.05.2026    & REST API            \\ \hline
    Задача 3.4. Реализация корзины, оформления заказа и истории покупок                               & 12                 & 09.05.2026    &                     \\ \hline
    Задача 3.5. Реализация поиска, фильтрации и сортировки товаров                                    & 6                  & 15.05.2026    &                     \\ \hline
    ...
    Задача 4.2. Развертывание приложения и базы данных                                                & 4                  & 26.05.2026    & Docker              \\ \hline
...
\renewcommand{\arraystretch}{1.2}
\begin{tabularx}{\textwidth}{@{} P{0.4\textwidth} P{0.25\textwidth} P{0.35\textwidth} @{}}

    «\underline{30}» \quad \underline{марта} \quad 2026~г. &
    \centering \includegraphics[height=1.2cm]{images/подпись.png} \par \vspace{-0.2cm} \footnotesize (подпись) &
    \hfill Кузнецов Данила Ростиславович                          \\
\end{tabularx}
}
